...
TESTSDIR='/home/oops/Documents/tests-ei-daily-201411092247'

# Directorio base do projecto
PROJDIR='/home/oops/Documents/project/'
...
do
    ...
    then
      java -Dimport=$TESTSDIR/$filename.import -Din=$TESTSDIR/$filename.in -Dout=$TEMPDIR/test.outhyp -cp $PROJDIR/poof-textui/poof-textui.jar:$PROJDIR/poof-textui/poof-textui.jar:$PROJDIR/poof-core/poof-core.jar:$SUPPORTDIR/po-uilib.jar:$SUPPORTDIR/poof-support.jar:$SUPPORTDIR/poof-support.jar poof.textui.Shell
    else
      java -Din=$TESTSDIR/$filename.in -Dout=$TEMPDIR/test.outhyp -cp $PROJDIR/poof-textui/poof-textui.jar:$PROJDIR/poof-textui/poof-textui.jar:$PROJDIR/poof-core/poof-core.jar:$SUPPORTDIR/po-uilib.jar:$SUPPORTDIR/poof-support.jar:$SUPPORTDIR/poof-support.jar poof.textui.Shell
    fi
